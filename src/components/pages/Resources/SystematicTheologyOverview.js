                      ...
                      <div className="node node-page clearfix">
                        <div className="content">
                          <div className="siteorigin-widget-tinymce textwidget">
                            ...
                            <h4 className="header-lightBlue">There are two levels of participation for each module</h4>
                            <h5>Full</h5>
                            <ul>
                            ...
                            <h4 className="header-lightBlue">General Information</h4>
                            <p>
                            ...
                            <p><strong>Certification?</strong> The course is completely “in-house.” Those, however, who complete the “full” course will be issued a certificate of completion by Cornerstone Presbyterian Church.<br /><br />
                              <strong>Registration:</strong> For more information, or to register, simply send a text or email to Course Administrator Cristiane Baker on 0404 392 812, or <a href="mailto:c9baker@gmail.com">c9baker@gmail.com</a>, by Monday February 12. Alternatively, you can respond to the Facebook event page <a href="https://www.facebook.com/events/139209490053621/" target="_blank" rel="noopener noreferrer">here</a>.</p>
                          </div>
                        </div>
