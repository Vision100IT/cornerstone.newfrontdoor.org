...
class SystematicTheologyNotes extends Component {
            ...
            <div className="row">
              <div id="top-content-left-region" className="top-content-left col-xs-12 col-md-6 text-center-sm">
                <div id="page-title-block" className="page-title block">
                  <h1>Systematic Theology Notes</h1>
                </div>
              </div>
                    ...
                    <div className="content">
                      <div className="node node-page clearfix">
                        <div className="content">
                          ...
                          </p><blockquote>Systematic Theology Notes Content Here </blockquote>
...
export default SystematicTheologyNotes;
